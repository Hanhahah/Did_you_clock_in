                                ...
                                <div class="table-responsive">
                                    <table class="table table-styled mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>${join.onumber}</td>
                                            <td><span class="img-thumb "><img src="assets/images/table/1.jpg" alt=" "><span class="ml-2 ">${join.oname}</span></span></td>
                                            <td>
                                                <a href="<%=request.getContextPath() +"/delete-join" %>?idonu=${join.onumber}" class="delete_button"><button class="mb-0 badge badge-primary" >退出</button></a>
