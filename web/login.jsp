            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="ad-auth-content">
                    <form action="LoginServlet" method="post">
                        <a href="index.html" class="ad-auth-logo"><img src="assets/images/logo2.png" alt="" /></a>
                        ...
                        <div class="ad-auth-form">
                            <div class="ad-auth-feilds mb-30">
                                <input type="text" placeholder="Telephone" class="ad-input" name="telephone" />
                        ...
                        <div class="ad-auth-btn"><button type="submit" class="ad-btn ad-login-member">Login</button></div>
