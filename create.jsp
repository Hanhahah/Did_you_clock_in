  ...
  <aside class="sidebar-wrapper">
    <div class="side-menu-wrap">
      <ul class="main-menu">
        ...
        <li><a href="org-list.jsp"><span class="icon-menu feather-icon">
    ...
    <div class="main-content"><!-- Page Title Start -->
     <div class="rg_center">
          <div class="card-header">
              <h4 class="card-title mb-0">创建组织</h4>
            ...
            <div class="card-body">
              <form action="CreateServlet" method="post">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="oname" id="oname" class="form-control"  data-bs-original-title="" title="">
                </div>
                <div class="mb-3">
                  <label class="form-label">截至时间</label>
                  <input type="time" name="stime" id="stime"  class="form-control"  data-bs-original-title="" title="">
                </div>
                <div class="mb-3">
                  <label class="form-label">提醒时间</label>
                  <input type="time" name="atime" id="atime"  class="form-control" data-bs-original-title="" title="">
                </div>
                <div class="mb-3">
                  <label class="form-label">邀请码</label>
                   <input class="form-control" type="text" required="required" name="getdate" id="date" onblur="checkdate()"
                  	 disabled="disabled" value="${invite}"></div>
