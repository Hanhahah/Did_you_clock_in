...
<div class="page-wrapper"><!-- Header Start -->
  <header class="header-wrapper main-header">
    <div class="header-inner-wrapper">
      <div class="logo-wrapper"><a href="index.html" class="admin-logo"><img src="assets/images/logo.png" alt=""></a></div>
    ...
    <div class="side-menu-wrap">
      <ul class="main-menu">
        <li><a href="javascript:void(0);" class="active"><span class="icon-menu feather-icon">
          ...
          <ul class="sub-menu">
            <li><a href="clocktoday.html"><span class="icon-dash"></span><span class="menu-text">今日打卡 </span></a></li>
            <li><a href="clockdetail.html"><span class="icon-dash"></span><span class="menu-text">打卡详情 </span></a></li>
          </ul>
        </li>
        ...
        <li><a href="user.html"><span class="icon-menu feather-icon">
    ...
    <div class="main-content"><!-- Page Title Start -->
      <div class="rg_center">
        <div class="card-header">
          <h4 class="card-title mb-0">设置组织信息</h4>
        ...
        <div class="card-body">
          <form action = "UpdateOrgServlet" method="post">
            <%
            int onumber;
            ...
            <div class="mb-3">
              ...
              <input class="form-control" type="text" required="required" name="setname" onblur="checkdate()">
            </div>
            <div class="mb-3">
              <label class="form-label">截止时间：</label>
              <input class="form-control" type="time" required="required" name="report" onblur="checkdate()">

            </div>
            <div class="mb-3">
              <label class="form-label">提醒时间：</label>
              <input class="form-control" type="time" required="required" name="remind"  onblur="checkdate()"></div>
